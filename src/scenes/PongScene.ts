...
export default class PongScene extends Phaser.Scene
{
    ...
    preload() : void {
        ...
        //Images buffer
        this.load.image('background', 'public/assets/soccer.jpg')
        this.load.image('border_h', 'public/assets/bar_h.png')
        this.load.image('border_v', 'public/assets/bar_v.png')
        this.load.image('bar', 'public/assets/bar.png')
        this.load.image('shine', 'public/assets/red.png')
